...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 text-gray-900 dark:text-gray-50">
      ...
      {/* Navigation Tabs */}
      <nav className="sticky top-0 bg-islamic-600 dark:bg-gray-800 shadow-lg z-40 overflow-x-auto">
          ...
          {tabs.map(tab => (
            <div key={tab.id} className="group relative">
              ...
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
                <div className="bg-gray-900 dark:bg-gray-700 text-white px-3 py-1 rounded-lg text-sm font-semibold whitespace-nowrap shadow-lg" dir="rtl">
                  {tab.arabic}
                </div>
      ...
      {/* Footer */}
      <footer className="bg-gray-100 dark:bg-gray-900 mt-12 py-8 text-center text-gray-600 dark:text-gray-400">
